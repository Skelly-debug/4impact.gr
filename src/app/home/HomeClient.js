...
export default function HomeClient() {
  ...
  return (
    <div className="font-playfair-display bg-gray-50 overflow-hidden">
      {/* Navbar */}
      <Navbar />
      ...
      <div className="relative h-screen">
        ...
        <div className="flex justify-center items-center h-full px-4">
          <h1
            className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white text-center relative z-10 transition-all duration-1000 ease-out ${
              showTitle
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 lg:py-20">
        ...
        {[
          ...
          "Αν ψάχνετε έναν συνεργάτη που θα μοιραστεί το όραμά σας και θα σας καθοδηγήσει προς απτά αποτελέσματα μέσω στοχευμένων λύσεων και στρατηγικών επικοινωνίας, είμαστε εδώ για να κάνουμε τα σχέδιά σας πραγματικότητα.",
        ].map((text, index) => (
          <p
            key={index}
            className="text-lg sm:text-xl md:text-2xl text-gray-800 text-center my-8 md:my-12 mx-auto max-w-[90%] md:max-w-2xl lg:max-w-prose leading-relaxed font-light"
          >
            {text}
          </p>
        ))}
